...
struct BlockFmhaBwdPipelineProblem
{
    ...
    static constexpr bool kSkipDQBwdNonMaskEdgeCheck   = Traits::kSkipDQBwdNonMaskEdgeCheck;
    static constexpr bool kSkipDKDVBwdNonMaskEdgeCheck = Traits::kSkipDKDVBwdNonMaskEdgeCheck;
    static constexpr bool kSkipDVBwdNonMaskEdgeCheck   = Traits::kSkipDVBwdNonMaskEdgeCheck;
};
