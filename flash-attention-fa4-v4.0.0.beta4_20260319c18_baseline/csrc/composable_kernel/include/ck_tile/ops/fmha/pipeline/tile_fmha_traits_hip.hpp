...
template <index_t kPadHeadDimQ_ /* paddding for hdim_q */,
          ...
          bool kHasBiasGrad_,
          index_t kBlockPerCu_ = -1, /* overwrite occupancy if not -1 */
          bool kSkipDQBwdNonMaskEdgeCheck_   = false,
          bool kSkipDKDVBwdNonMaskEdgeCheck_ = false,
          bool kSkipDVBwdNonMaskEdgeCheck_   = false>
struct TileFmhaBwdTraits
{
    ...
    static constexpr bool kHasBiasGrad    = kHasBiasGrad_;
    static constexpr index_t kBlockPerCu  = kBlockPerCu_;
    static constexpr bool kSkipDQBwdNonMaskEdgeCheck   = kSkipDQBwdNonMaskEdgeCheck_;
    static constexpr bool kSkipDKDVBwdNonMaskEdgeCheck = kSkipDKDVBwdNonMaskEdgeCheck_;
    static constexpr bool kSkipDVBwdNonMaskEdgeCheck   = kSkipDVBwdNonMaskEdgeCheck_;
