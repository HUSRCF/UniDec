...
#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_LATE_DO_D_PREFETCH
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_LATE_DO_D_PREFETCH 0
#endif

#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_LATE_REG_LOAD
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_LATE_REG_LOAD 0
#endif

#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_INPLACE_DS
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_INPLACE_DS 0
#endif

#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_NO_INPLACE_DS
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_NO_INPLACE_DS 0
#endif

#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_ALLOW_LATE_LOAD
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_ALLOW_LATE_LOAD 0
#endif

#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_ALLOW_LATE_LOAD_NONMASK
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_ALLOW_LATE_LOAD_NONMASK 0
#endif

#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_LATE_Q_ONLY_NONMASK
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_LATE_Q_ONLY_NONMASK 0
#endif

#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_NO_DS_PREFETCH_NEXT
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_NO_DS_PREFETCH_NEXT 0
#endif

#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_SCOPE_DS_GEMM_STORE
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_SCOPE_DS_GEMM_STORE 0
#endif

#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_STATIC_DQ_WINDOW
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_STATIC_DQ_WINDOW 0
#endif

#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_STATIC_DQ_WINDOW_RAW
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_STATIC_DQ_WINDOW_RAW 0
#endif

#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_SINGLE_K4_FAST
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_SINGLE_K4_FAST 0
#endif

#ifndef CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_TAIL_DIRECT_UPDATE
#define CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_TAIL_DIRECT_UPDATE 0
#endif

#ifndef CK_TILE_DEBUG_BWD_DQ_D256_NONMASK_NO_EDGE_CHECK
#define CK_TILE_DEBUG_BWD_DQ_D256_NONMASK_NO_EDGE_CHECK 0
#endif
...
struct BlockFmhaBwdDQPipelineKRKTRVRIGLP
{
    ...
    static constexpr bool kAllowD256LateLoad =
        (CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_ALLOW_LATE_LOAD != 0) && kUseD256HybridFast &&
        (FmhaMask::IsMasking ||
         (!FmhaMask::IsMasking && CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_ALLOW_LATE_LOAD_NONMASK != 0));
    static constexpr bool kUseLateDoDPrefetch =
        (CK_TILE_DEBUG_BWD_SPLIT_DQ_LATE_DO_D_PREFETCH != 0) &&
        (!kUseD256HybridFast || kAllowD256LateLoad);
    static constexpr bool kUseLateRegLoad =
        (CK_TILE_DEBUG_BWD_SPLIT_DQ_LATE_REG_LOAD != 0) &&
        (!kUseD256HybridFast || kAllowD256LateLoad);
    static constexpr bool kUseD256LateQOnlyNonMask =
        (CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_LATE_Q_ONLY_NONMASK != 0) && kUseD256HybridFast &&
        !FmhaMask::IsMasking;
    static constexpr bool kUseLateQRegLoad = kUseLateRegLoad || kUseD256LateQOnlyNonMask;
    static constexpr bool kUseLateDoDRegLoad = kUseLateRegLoad;
    static constexpr bool kDisableD256DSPrefetchNext =
        (CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_NO_DS_PREFETCH_NEXT != 0) && kUseD256HybridFast;
    static constexpr bool kDisableD256InplaceDS =
        (CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_NO_INPLACE_DS != 0) && kUseD256HybridFast;
    static constexpr bool kUseInplaceDS =
        ((CK_TILE_DEBUG_BWD_SPLIT_DQ_INPLACE_DS != 0) || kUseD256HybridFast) &&
        !kDisableD256InplaceDS;
    static constexpr bool kUseD256TailDirectUpdate =
        (CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_TAIL_DIRECT_UPDATE != 0) && kUseD256HybridFast &&
        !FmhaMask::IsMasking && !kIsGroupMode && !FmhaDropout::IsDropout && !kHasBiasGrad &&
        !kIsDeterministic;
    static constexpr bool kUseStaticDQWindow =
        (CK_TILE_DEBUG_BWD_SPLIT_DQ_STATIC_DQ_WINDOW != 0) && kUseD256HybridFast;
    static constexpr bool kUseD256SingleK4Fast =
        (CK_TILE_DEBUG_BWD_SPLIT_DQ_D256_SINGLE_K4_FAST != 0) && kUseD256HybridFast &&
        (kN0 / kK4) == 1;
    // Experimental D256 batch nonmask fast path. Invalid K-tail lanes are isolated by the
    // split-DQ dataflow and do not contribute to valid DQ rows, but group/varlen needs its
    // own validation before this edge cleanup can be skipped there.
    static constexpr bool kSkipD256NonMaskEdgeCheck =
        ((CK_TILE_DEBUG_BWD_DQ_D256_NONMASK_NO_EDGE_CHECK != 0) ||
         Problem::kSkipDQBwdNonMaskEdgeCheck) &&
        kUseD256HybridFast &&
    ...
    static constexpr const char* name = "kr_ktr_vr_iglp_dq";
               ...
               FmhaDropout& dropout) const
    {
        ...
        auto null_return = []() { return make_tuple(ck_tile::null_type{}, ck_tile::null_type{}); };
        ...
        // ----------------------------Loop write out------------------------------//
        auto dq_dram_window = [&]() {
            if constexpr(kUseStaticDQWindow)
            {
        ...
        auto remap_dq_acc_for_store = [&](const auto& dq_tile_like) {
            ...
            auto dq_acc_lds_window = [&]() {
                ...
                auto dq_acc_lds_view =
                    make_tensor_view<address_space_enum::lds>(dq_acc_lds_ptr, dq_acc_lds_desc);
            ...
            auto dq_store = make_static_distributed_tensor<AccDataType>(
                Policy::template MakePostQGradDramTileDistribution<Problem>());
        ...
        while(i_total_loops < (num_total_loop - 1))
        {
            ...
            if constexpr(!kUseLateDoDPrefetch)
            {
...

            {
                bool need_perpixel_check = [&]() {
                    if constexpr(kSkipD256NonMaskEdgeCheck)
                    {
                        return false;
                    }
                    else
                    {
                        return mask.IsEdgeTile(seqlen_q_step,
            ...
            if constexpr(kUseLateDoDRegLoad)
            {
                if(i_total_loops > 0)
                {
...
#if CK_TILE_DEBUG_BWD_SPLIT_DQ_SCOPE_DS_GEMM_STORE != 0
            {
#endif
            const auto ds_gemm = [&]() {
                if constexpr(kUseD256HybridFast)
                {
                    const auto build_ds_gemm = [&](auto& ds) {
                        constexpr auto ds_spans = SPGradBlockTileType::get_distributed_spans();
                        sweep_tile_span(ds_spans[number<0>{}], [&](auto idx0) {
                            constexpr auto i_idx = make_tuple(idx0);
                            sweep_tile_span(ds_spans[number<1>{}], [&](auto idx1) {
                                constexpr auto i_j_idx = make_tuple(idx0, idx1);
                                bool undrop_flag       = p[i_j_idx] >= 0;
                                ds(i_j_idx)            = p[i_j_idx] *
                                       (!FmhaDropout::IsDropout || undrop_flag
                        ...
                        return cast_tile<GemmDataType>(ds);
                    };
                    if constexpr(kUseInplaceDS)
                    {
                        return build_ds_gemm(dp_acc);
                    }
                    else
                    {
                        auto ds = SPGradBlockTileType{};
                        return build_ds_gemm(ds);
                    }
                }
                else
                {
#if CK_TILE_DEBUG_BWD_SPLIT_DQ_INPLACE_DS != 0
                    auto& ds                = dp_acc;
                    constexpr auto ds_spans = decltype(dp_acc)::get_distributed_spans();
#else
                    auto ds                 = SPGradBlockTileType{};
            ...
            if constexpr(kUseD256SingleK4Fast)
            {
                auto kt_reg_tensor_slice =
                    get_slice_tile(kt_reg_tensor,
                                   sequence<0, 0>{},
                                   sequence<kQKHeaddim, kK4>{});
            ...
            else
            {
                ...
                static_for<0, k4_loops, 1>{}([&](auto i_k4) {
                    ...
                    {
                        if constexpr(!kDisableD256DSPrefetchNext)
                        {
                    ...
                    if constexpr(i_k4 < k4_loops - 1)
                    {
                        if constexpr(kDisableD256DSPrefetchNext)
                        {
                            ds_reg_tensor = load_tile(ds_lds_read_window);
                            move_tile_window(ds_lds_read_window, {0, kK4});
                        }
                        else
                        {
            ...
            {
#if CK_TILE_DEBUG_BWD_SPLIT_DQ_STATIC_DQ_WINDOW_RAW != 0
                if constexpr(kUseStaticDQWindow)
                {
                    update_tile_raw(dq_dram_window, dq_acc);
                }
                else
#endif
                {
            ...
            if constexpr(kUseStaticDQWindow)
            {
                move_tile_window(dq_dram_post_window, {kM0, 0});
            }
        ...
        __builtin_amdgcn_sched_barrier(0);
            ...
            {
                if constexpr(kUseD256TailDirectUpdate)
                {
                    update_tile(dq_dram_window, dq_acc);
                }
                else
                {
                    ...
                    if constexpr(kUseStaticDQWindow)
                    {
                        update_tile_raw(dq_dram_post_window, dq_store_tile);
                    }
                    else
#endif
                    if constexpr(kUseStaticDQWindow)
                    {
                        update_tile(dq_dram_post_window, dq_store_tile);
                    }
                    else
                    {
                        update_tile(dq_dram_window, dq_store_tile);
                    }
                }
            }
        }
