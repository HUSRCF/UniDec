...
#ifndef CK_TILE_DEBUG_DRAIN_VMCNT_BEFORE_2D_EPILOGUE_STORE
#define CK_TILE_DEBUG_DRAIN_VMCNT_BEFORE_2D_EPILOGUE_STORE 0
#endif
...
struct Default2DEpilogue
{
                                   ...
                                   void* = nullptr) const
    {
        ...
        const auto storeOrUpdateTile = [&](const auto& o_tile) {
            // TODO: this is ugly
#if CK_TILE_DEBUG_DRAIN_VMCNT_BEFORE_2D_EPILOGUE_STORE
