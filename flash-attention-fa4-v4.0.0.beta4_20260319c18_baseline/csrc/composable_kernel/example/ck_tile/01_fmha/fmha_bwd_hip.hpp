...
#ifndef CK_TILE_DEBUG_FORCE_ROW_STORE
#define CK_TILE_DEBUG_FORCE_ROW_STORE 1
#endif

#include "ck_tile/ops/fmha_hip.hpp"
#include "ck_tile/ops/fmha/pipeline/block_fmha_bwd_dk_dv_pipeline_kr_ktr_vr_iglp_hip.hpp"
#include "ck_tile/ops/fmha/pipeline/block_fmha_bwd_dq_pipeline_kr_ktr_vr_iglp_hip.hpp"
...
template <typename FmhaBwdDQQMajorKernel>
auto fmha_bwd_dq_qmajor_create_kargs_and_grids(fmha_bwd_args args)
{
    static_assert(!FmhaBwdDQQMajorKernel::kIsGroupMode,
                  "Q-major split DQ trial supports batch mode only.");
    assert(args.nhead_q % args.nhead_k == 0);
    auto kargs = FmhaBwdDQQMajorKernel::MakeKargsImpl(args.q_ptr,
                                                      args.k_ptr,
                                                      args.v_ptr,
                                                      args.bias_ptr,
                                                      args.lse_ptr,
    ...
    dim3 grids = FmhaBwdDQQMajorKernel::GridSize(args.batch, args.nhead_q, args.max_seqlen_q);
    return ck_tile::make_tuple(kargs, grids);
}
...
struct fmha_bwd_dq_dk_dv_traits_
{
    ...
    static constexpr ck_tile::BlockAttentionBiasEnum BiasEnum = BiasEnum_;
    static constexpr bool kHasBiasGrad     = kHasBiasGrad_;
    static constexpr bool kPadD            = kPadD_;
    static constexpr bool kPadDv           = kPadDv_;
    static constexpr bool kIsDeterministic = kIsDeterministic_;
    static constexpr bool kUseTrLoad       = kUseTrLoad_;
    static constexpr ck_tile::index_t MaxSeqLenQ = MaxSeqLenQ_;
    static constexpr ck_tile::index_t N0         = kN0;
    static constexpr bool kUseExactNoEdge        = kUseExactNoEdge_;

    using ExactNoEdge = fmha_bwd_dq_dk_dv_traits_<HDim_,
                                                  DataType_,
                                                  kIsGroupMode_,
                                                  FmhaMask_,
                                                  FmhaDropout_,
...
template <typename Traits_, typename Arch = void>
void fmha_bwd_dv_oneshot_(const ck_tile::stream_config&, fmha_bwd_args);

template <typename Traits_, typename Arch = void>
std::string fmha_bwd_dv_get_name_();

template <typename Traits_, typename Arch = void>
void fmha_bwd_dkdv_oneshot_(const ck_tile::stream_config&, fmha_bwd_args);

template <typename Traits_, typename Arch = void>
std::string fmha_bwd_dkdv_get_name_();

template <typename Traits_, typename Arch = void>
void fmha_bwd_dk_oneshot_(const ck_tile::stream_config&, fmha_bwd_args);

template <typename Traits_, typename Arch = void>
std::string fmha_bwd_dk_get_name_();

template <typename Traits_, typename Arch = void>
void fmha_bwd_dq_oneshot_(const ck_tile::stream_config&, fmha_bwd_args);

template <typename Traits_, typename Arch = void>
std::string fmha_bwd_dq_get_name_();

template <typename Traits_, typename Arch = void>
void fmha_bwd_dq_qmajor_oneshot_(const ck_tile::stream_config&, fmha_bwd_args);

template <typename Traits_, typename Arch = void>
std::string fmha_bwd_dq_qmajor_get_name_();
