...
#if CK_TILE_DEBUG_DUMP_A_TMP
    if constexpr(FmhaKernel::kIsGroupMode)
    {
        std::printf(
            "[O_KARG] mode=group o_ptr=%p seqlen_q=%lld max_seqlen_q=%lld hdim_v=%lld nhead_q=%lld "
            "stride_o=%lld nhead_stride_o=%lld\n",
            args.o_ptr,
            static_cast<long long>(args.seqlen_q),
            static_cast<long long>(args.max_seqlen_q),
            static_cast<long long>(args.hdim_v),
            static_cast<long long>(args.nhead_q),
            static_cast<long long>(args.stride_o),
            static_cast<long long>(args.nhead_stride_o));
    }
    else
    {
        std::printf(
            "[O_KARG] mode=batch o_ptr=%p batch=%lld seqlen_q=%lld max_seqlen_q=%lld hdim_v=%lld "
            "nhead_q=%lld stride_o=%lld nhead_stride_o=%lld batch_stride_o=%lld\n",
            args.o_ptr,
            ...
            static_cast<long long>(args.stride_o),
            static_cast<long long>(args.nhead_stride_o),
            static_cast<long long>(args.batch_stride_o));
    }
#endif
