...
mha_fwd(at::Tensor &q,                            // batch_size x seqlen_q x num_heads x round_multiple(head_size, 8)
        ...
        std::optional<at::Tensor> &q_descale_,    // FP8 descale for Q
        std::optional<at::Tensor> &k_descale_,    // FP8 descale for K
        std::optional<at::Tensor> &v_descale_,    // FP8 descale for V
...
#ifndef FLASH_ATTN_CK_MINIMAL_API
